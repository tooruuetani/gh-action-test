...
SET PYTHON_VER=3.9-64
SET PIP_VER=23.0
SET POETRY_VER=1.3.2


REM Avoid actual aws access
SET AWS_ACCESS_KEY_ID='testing'
SET AWS_SECRET_ACCESS_KEY='testing'
SET AWS_SECURITY_TOKEN='testing'
SET AWS_SESSION_TOKEN='testing'
...
IF EXIST poetry.lock (
  ...
  IF EXIST pyproject.toml (
    ...
    poetry add --group dev black flake8 mypy pytest pytest-cov
    IF NOT !ERRORLEVEL! equ 0 PAUSE
  )
)
